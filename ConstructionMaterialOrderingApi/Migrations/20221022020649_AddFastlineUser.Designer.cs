...
namespace ConstructionMaterialOrderingApi.Migrations
{
    ...
    [Migration("20221022020649_AddFastlineUser")]
    partial class AddFastlineUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConstructionMaterialOrderingApi.Models.FastlineUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConstructionMaterialOrderingApi.Models.RegisteredCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConstructionMaterialOrderingApi.Models.VerifiedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConstructionMaterialOrderingApi.Models.RegisteredCompany", b =>
                {
                    b.HasOne("ConstructionMaterialOrderingApi.Models.HardwareStore", "HardwareStore")
                        .WithMany()
                        .HasForeignKey("HardwareStoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HardwareStore");
                });
